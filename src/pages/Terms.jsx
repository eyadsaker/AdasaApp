      ...
      <div class="bg-[#0a0a0a]">
        <header class="relative py-20 overflow-hidden">
          ...
          <div class="absolute inset-0 opacity-30">
            <div class="absolute bottom-20 left-20 w-72 h-72 bg-yellow-500/20 rounded-full blur-[100px]"></div>
          </div>
          <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <nav class="flex items-center justify-center gap-2 text-sm mb-8">
              ...
              <svg
                class="w-4 h-4 text-neutral-600 rotate-180"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <span class="text-orange-500 font-medium">شروط الخدمة</span>
            </nav>
            <div class="inline-flex items-center justify-center w-16 h-16 bg-orange-500/10 backdrop-blur-sm rounded-2xl border border-orange-500/30 mb-6">
              <svg
            ...
            <p class="text-neutral-400 text-lg">آخر تحديث: 15 يناير 2026</p>
          </div>
        </header>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div class="bg-yellow-500/10 border border-yellow-500/20 rounded-2xl p-6 mb-12">
          ...
          <div class="space-y-12">
            ...
            <section class="group">
              ...
              <div class="pr-11">
                ...
                <p class="text-neutral-300 font-medium mb-3">
            ...
            <section class="group">
              ...
              <div class="pr-11">
                ...
                <a
                  ...
                  class="inline-flex items-center gap-2 text-orange-500 hover:text-orange-400 font-medium"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
          ...
          <div class="mt-16 pt-8 border-t border-[#262626]">
