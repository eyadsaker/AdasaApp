      ...
      <div className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden bg-[#0a0a0a] ">
        ...
        <div className="relative text-center px-4 max-w-lg mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
            <Link
              className=" rounded-full linear inline-flex items-center justify-center gap-2 group text-white font-bold"
              to="/"
            >
              <svg
                className="w-5 h-5"
            ...
            <Link
              className=" inline-flex items-center justify-center gap-2 rounded-full py-4 px-8 text-white font-bold border border-zinc-800"
              to="/blog "
            >
              <svg
                className="w-5 h-5"
